...
// than the comparison value. Note the additional inclusion of the
// 'inline' to avoid issues with multiple definitions when using the
// header file in multiple files.

inline int minMax( double comp, std::vector<double> x, int Direction ) {
